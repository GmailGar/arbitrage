...
# Загружаем контракты из JSON без преобразования ключей в нижний регистр
...
def index():
    ...
    if request.method == 'POST':
        ...
        if token in token_contracts:
            ...
            token_lower = token.lower()  # Преобразование только для ссылок
            trade_link = f"https://www.lbank.com/trade/{token_lower}_usdt"
            deposit_link = f"https://www.lbank.com/wallet/account/main/deposit/crypto/{token_lower}/solana"
